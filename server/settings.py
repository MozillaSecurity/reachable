...
# you can probably use similar code to get 2FA for your Reachable instance.
...
LOGGING = {
    ...
    'handlers': {
        ...
        'reachable_logfile': {
            ...
            'filename': os.path.join(LOG_DIR, 'reachable.log'),
            'maxBytes': 16777216,
            'formatter': 'simple'
        },
        'mail_admins': {
...
# If you are running Reachable behind a TLS loadbalancer,
...
# This is the base directory where the data/ subdirectory will
# be created for storing raw searchfox data downloaded from TC
DATA_STORAGE = os.path.join(BASE_DIR)
...
# CELERY_TASK_ROUTES = {
#     'reachable.cron.*': {'queue': 'cron'},
# }
# CELERY_BEAT_SCHEDULE = {
#     'Poll new Searchfox data and cleanup old data': {
#         'task': 'reachable.cron.cycle_mozsearch_index_data',
#         'schedule': 60 * 60 * 24,
#     },
# }
